            ...
            <Col lg="4">
              ...
              <form>
                ...
                <select
                  ...
                  onChange={e => {
                    this.handleInputChange("channels", e);
                  }}
                >
                ...
                <input
                  ...
                  onChange={e => {
                    this.handleInputChange("dateRangeStart", e);
                  }}
                />
                ...
                <input
                  ...
                  onChange={e => {
                    this.handleInputChange("dateRangeEnd", e);
                  }}
                />
                <br />
                ...
                <input
                  ...
                  onChange={e => {
                    this.handleInputChange("pictureUrl", e);
                  }}
                />
                <input
                  type="file"
                ...
                <select
                  ...
                  onChange={e => {
                    this.handleInputChange("mediaType", e);
                  }}
                >
                  <option value="Video">Video</option>
                ...
                <input
                  ...
                  onChange={e => {
                    this.handleInputChange("sourceUrl", e);
                  }}
                />
